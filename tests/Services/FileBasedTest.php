...
use ampfTest\Support\AlwaysSweepingFileBased;
use ampfTest\Support\NeverSweepingFileBased;
use PHPUnit\Framework\TestCase;

/**
 * @internal
 *
 * @covers \ampf\services\cache\string\impl\FileBased
 */
final class FileBasedTest extends TestCase
{
    ...
    public function testTheSweepRemovesTheExpiredEntriesAndNothingElse(): void
    {
        ...
        file_put_contents($this->directory . '/twemoji.tar.gz', 'archive');
        ...
        self::assertSame(
            ['doctrine', 'folder.asc', 'fresh.asc', 'not a key.asc', 'phpstan.asc.bak', 'twemoji.tar.gz'],
            $this->listDirectory(),
        );
    ...
    {
        $cache = new AlwaysSweepingFileBased();
    ...
    private function newCache(): FileBased
    {
        $cache = new NeverSweepingFileBased();
